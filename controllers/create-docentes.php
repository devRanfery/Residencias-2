...
<div class="container">
	...
	$checkEmail = "SELECT * FROM Docente WHERE id_docente = '$_POST[num_control]'";
	...
	*/
	...
	$query = "INSERT INTO Docente (id_docente, d_nombre, d_ap_paterno, d_ap_materno, d_correo, d_telefono, contrasena) 
	VALUES ('$num_control', '$nombre', '$ap_paterno', '$ap_materno','$correo', '$telefono', '$passHash')";
