...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="../views/perfil_docente.php">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <section id="tabla_resultado">
                    ...
                    $sql = "SELECT Alumno.*, Residencias.* FROM Alumno INNER JOIN Residencias ON Alumno.id_alumno = Residencias.id_alumno WHERE Residencias.id_docente = '$num_c'";
                    ...
                    if ($resultado->num_rows > 0) {
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">Numero de control</th>
                                    <td><? echo $row['id_alumno']; ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th scope="row">Grado y grupo</th>
                                    <td><? echo $row['grado']; ?> <? echo $row['grupo']; ?></td>
                                </tr>
                                <tr>
                                    <th scope="row">Telefono</th>
                                    <td><? echo $row['a_telefono']; ?></td>
                                </tr>
                                <tr>
                                    <th scope="row">Correo</th>
                                    <td><? echo $row['a_correo']; ?></td>
                                </tr>
                                <tr>
